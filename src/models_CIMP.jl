...
#LAZY CUTS GBD
function startLazyBendersCallbackCIMP( cb_data::CPLEX.CallbackContext, context_id::Clong, inst::instance, params::Dict, res::results, b::bfsdata, model::Model )
...
function startUserBendersCallbackCIMP( cb_data::CPLEX.CallbackContext, context_id::Clong, inst::instance, params::Dict, res::results, b::bfsdata, model::Model )
    eps::Float64 = 0.001
    relcuttol::Float64 = deepcopy( params["relcuttolU"] )
    #cuttype::Int = deepcopy( params["cutType"] )
    wherefrom::String = "UCB"
    #prepro  = deepcopy( params["prepro"] )
...
function startOACallbackCIMP( cb_data::CPLEX.CallbackContext, context_id::Clong, inst::instance, params::Dict, res::results, b::bfsdata, model::Model, wherefrom::String )
    relcuttol::Float64 = params["relcuttol"]

    CPLEX.load_callback_variable_primal(cb_data, context_id)
    b.yv_val = callback_value.(Ref(cb_data), model[:yv]) 
    u_val = callback_value.(Ref(cb_data), model[:u]) 
